...
class StatisticsCalculator:
    ...
    def __init__(self, model_names: list[str], ddof: int = 0):
        """
        Args:
    ...
    def _compute_means(self, data: dict, num_rounds: int) -> dict[str, dict[str, float]]:
        sums = {metric: dict.fromkeys(self.model_names, 0.0) for metric in METRICS}
    ...
    def _compute_stds(
        ...
        sum_sq_diffs = {metric: dict.fromkeys(self.model_names, 0.0) for metric in METRICS}
